            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="{{ route('page1') }}">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('page2') }}">Services</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('page3') }}"> About</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('page4') }}">Portfolio</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('page5') }}">Contact Us</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('page6') }}">
