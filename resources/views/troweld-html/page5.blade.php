    ...
    <header class="header_section">
      <div class="header_top">
        <div class="container-fluid header_top_container">
          ...
          <a class="navbar-brand " href="{{ route('page1') }}"> EngageIt<span>solution</span> </a>
          ...
          <div class="form_container">
            <form action="">
              ...
              <div class="form-row">
                ...
                <div class="form-row">
                  <div class="form-group col">
                    <input type="text" class="form-control" placeholder="votre pays" />
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col">
                ...
                <div class="form-row">
                  <div class="form-group col">
                    <input type="text" class="form-control" placeholder="votre commune" />
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col">
                    <input type="text" class="form-control" placeholder="votre quartier" />
                  </div>
                </div>
                <div class="form-group col-lg-6">
                  <select name="" id="" class="form-control wide">
                    <option value="">Select Service</option>
                    <option value="">COIFURE</option>
                    <option value="">MECANIQUE</option>
                    <option value="">CORDONNER</option>
                    <option value="">MINUSIER</option>
